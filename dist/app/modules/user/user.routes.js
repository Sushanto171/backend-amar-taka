...
router.get("/send-verify-otp", (0, checkAuth_1.checkAuth)([...Object.values(user_interface_1.IRole)]), user_controller_1.userController.sendVerifyOTP);
router.post("/verify-otp", (0, validateZodSchema_1.validateRequest)(user_validator_1.verifyOTPZodSchema), (0, checkAuth_1.checkAuth)([...Object.values(user_interface_1.IRole)]), user_controller_1.userController.verifyOTP);
