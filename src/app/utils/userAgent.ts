...
export const getClientInfo = (req: Request) => {
  ...
  else if (/samsung|sm-|gt-|sch-|shv-/.test(ua)) brand = "Samsung";
  else if (/redmi|mi |xiaomi/.test(ua)) brand = "Xiaomi";
  ...
  else if (/nokia/.test(ua)) brand = "Nokia";
